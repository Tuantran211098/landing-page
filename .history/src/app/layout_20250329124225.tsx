// ❌ Không dùng "use client" ở đây, vì `metadata` cần Server Component

import { ReactNode } from "react";
import QueryProvider from "@/components/QueryProvider"; // Import file mới tạo
