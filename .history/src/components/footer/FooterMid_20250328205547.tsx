  ...
  return (
    <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} className="footerMid">
      ...
      >
        ...
        <div className="mg-top footer__items--channel">
        ...
        <div className="mg-top footer__items--website">
        ...
        <div className="mg-top footer__items-method">
          <img src="https://beta-api.bachlongmobile.com/media/snowdog/menu/node//1/_/1.png" />
          <img src="https://beta-api.bachlongmobile.com/media/snowdog/menu/node//2/_/2.png" />
          <img src="https://beta-api.bachlongmobile.com/media/snowdog/menu/node//l/o/logo_pptt_1.png" />
          <img src="https://beta-api.bachlongmobile.com/media/snowdog/menu/node//6/_/6.png" />
        </div>

        <div className="mg-top footer__items-declare">
          <img src="https://bachlongmobile.com/_next/image/?url=%2Fassets%2Fimages%2Flogo%2Flogo-bo-cong-thuong.png&w=640&q=75" />
        </div>
      </Col>
    </Row>
  );
